...
(function (blink) {
	...
	var TemporaldefifrancophoneStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	TemporaldefifrancophoneStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_Temporaldefifrancophone',
		ckEditorStyles: {
			name: 'Temporaldefifrancophone',
			styles: [
		...
		formatCarouselindicators: function (scope, classNavbar) {
			var that = scope || this,
				navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'Temporaldefifrancophone-navbar'),
	...
	TemporaldefifrancophoneStyle.prototype = _.extend({}, new blink.theme.styles.basic(), TemporaldefifrancophoneStyle.prototype);

	blink.theme.styles['Temporaldefifrancophone'] = TemporaldefifrancophoneStyle;
